...
def getAllOfTheData():
    try:
        TrainX    = placeDataIntoArray(os.path.join(os.getcwd(), R'new_data\train_x.csv'))
        TrainY    = placeDataIntoArray(os.path.join(os.getcwd(), R'new_data\train_y.csv'))
        ValidateX = placeDataIntoArray(os.path.join(os.getcwd(), R'new_data\validation_x.csv'))
        ValidateY = placeDataIntoArray(os.path.join(os.getcwd(), R'new_data\validation_y.csv'))
        TestX     = placeDataIntoArray(os.path.join(os.getcwd(), R'new_data\test_x.csv'))
        TestY     = placeDataIntoArray(os.path.join(os.getcwd(), R'new_data\test_y.csv'))
